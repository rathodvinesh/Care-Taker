...
class VolunteerRegistration : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val shiftTV = binding.editTextShift
        val serviceTV = binding.editTextService
        val amountTV = binding.editTextAmount
        ...
        binding.signUpBtnReg.setOnClickListener{
            ...
            val shift = shiftTV.text.toString()
            val service = serviceTV.text.toString()
